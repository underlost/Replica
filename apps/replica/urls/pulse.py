...
from replica.views import pulse as views
from replica.feeds import pulse as feeds
...
urlpatterns = patterns('',
	...
	#Static
	url(r'^feeds/$', TemplateView.as_view(template_name="replica/pulse/feeds.html")),
	url(r'^archive/$', TemplateView.as_view(template_name="replica/pulse/archive.html")),
